...
document.getElementById("container3Dwhite").appendChild(renderer.domElement);
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "cdwhite" ? 5 : 1);
scene.add(ambientLight);

// This adds controls to the camera, so we can rotate / zoom it with the mouse
if (objToRender === "cdwhite") {
...
const container3Dwhite = document.getElementById('container3Dwhite');
container3Dwhite.ondblclick = () => {
  window.location.href = 'sobre_mim.html';
};
